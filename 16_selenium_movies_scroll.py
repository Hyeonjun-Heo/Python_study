...
# 화면 가장 아래로 스크롤 내리기
# browser.execute_script("window.scrollTo(0, document.body.scrollHeight)") #현재 문서의 높이만큼 스크롤
...
movies = soup.find_all ("div", attrs={"class":"ULeU3b neq94b"}) 
...
for movie in movies :
    ...
    if original_price:
        original_price = original_price.get.text()
    else:
